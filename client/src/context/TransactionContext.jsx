...
export const TransactionProvider = ({ children }) => {
    ...
    const [transtionCount, setTransactionCount] = useState(localStorage.getItem('transactionCount'));
    ...
    const sendTransaction = async () => {
        try {
            ...
            // to store our stransaction, we need this. It is better to add this to a var which is a tx hash. This is async, gonna take a while to go trhough
